...
be I<type>, and repositories (in positional arguments or in the values
of options B<--fg> and B<--bg>) are simply given in form of a pathname of
a file containing the repository. If no positional argument is given
